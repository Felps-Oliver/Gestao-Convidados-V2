...
public abstract class DAO implements AutoCloseable{
	...
	private void conectar() {
		StringBuilder urlBuilder = new StringBuilder("jdbc:h2:mem:gestao-convidados-v2;")
										.append("DB_CLOSE_DELAY=-1;")
										.append("DATABASE_TO_UPPER=false;");
		
		if(primeiraInicializacao) {
			urlBuilder.append("INIT=runscript from 'classpath:CREATE_TABLE_INSERT_REGISTERS.sql';");
